...
"[project]/node_modules/wagmi/node_modules/@wagmi/connectors/dist/esm/porto.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function porto(parameters = {}) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$wagmi$2f$core$2f$dist$2f$esm$2f$connectors$2f$createConnector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createConnector"])((wagmiConfig)=>{
                ...
                try {
                    if (!accounts?.length && !isReconnecting) {
                        const { RpcSchema } = await (()=>{
                            ...
                            try {
                                return __turbopack_context__.A("[project]/node_modules/porto/dist/index.js [app-client] (ecmascript, async loader)");
                            } catch  {
                        ...
                        const { z } = await (()=>{
                            // safe webpack optional peer dependency dynamic import
                            try {
                                return __turbopack_context__.A("[project]/node_modules/porto/dist/internal/index.js [app-client] (ecmascript, async loader)");
                            } catch  {
                            ...
                            params: [
                                {
                                    ...
                                    chainIds: [
                                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$encoding$2f$toHex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["numberToHex"])(chainId),
                                        ...chains.filter((x)=>x.id !== chainId).map((x)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$encoding$2f$toHex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["numberToHex"])(x.id))
                                    ]
                                }
                            ]
                        });
                    ...
                    if (!currentChainId) throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$wagmi$2f$core$2f$dist$2f$esm$2f$errors$2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ChainNotConfiguredError"]();
                    // Manage EIP-1193 event listeners
                    // https://eips.ethereum.org/EIPS/eip-1193#events
                    if (connect) {
                        provider.removeListener('connect', connect);
...
//# sourceMappingURL=node_modules_c5bb40de._.js.map